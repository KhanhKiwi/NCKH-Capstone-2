      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border-2 border-amber-100">
          ...
          <div className="space-y-3">
            <button className="w-full py-3 border-2 border-gray-200 rounded-xl hover:border-amber-300 hover:bg-amber-50 transition-all duration-300 flex items-center justify-center gap-2">
