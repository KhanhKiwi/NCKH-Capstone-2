...
(1,'làng gốm Bát Tràng','Làng gốm Bát Tràng nằm nép mình bên dòng sông Thu Bồn thơ mộng. Nơi đây lưu giữ kỹ thuật chuốt gốm bằng tay truyền thống từ bao đời nay. Những bàn xoay nhịp nhàng tạo nên các sản phẩm mộc mạc nhưng đầy tinh xảo. Du khách có thể tự tay trải nghiệm nặn đất và mang về những kỷ niệm đáng nhớ. Đây chính là mảnh ghép văn hóa bình dị nhưng sâu sắc của phố cổ Hội An.','https://hoiancreativecity.com/uploads/images/297422627_1528835960864226_1414470664784784443_n.jpg','Hội An',NOW(),NOW(),NULL,1),
...
(1,'làng gốm Bát Tràng','Thực hành kỹ thuật làm gốm truyền thống Bát Tràng.',1,NOW(),NOW()),
