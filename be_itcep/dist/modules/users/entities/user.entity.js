...
__decorate([
    (0, typeorm_1.Column)({ name: 'google_id', type: 'varchar', length: 100, nullable: true, unique: true }),
    __metadata("design:type", Object)
...
__decorate([
    (0, typeorm_1.Column)({ name: 'reset_password_expires', type: 'datetime', nullable: true }),
    __metadata("design:type", Object)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => player_session_entity_1.PlayerSession, (session) => session.user),
    __metadata("design:type", Array)
