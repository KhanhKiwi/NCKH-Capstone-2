...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'Level ID (optional)' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], CreateFeedbackDto.prototype, "level_id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Great game, but too difficult', description: 'Feedback message' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateFeedbackDto.prototype, "message", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 4, description: 'Rating from 1-5', minimum: 1, maximum: 5 }),
    (0, class_validator_1.IsNumber)(),
