...
const craft_village_entity_1 = require("./entities/craft-village.entity");
let VillagesService = class VillagesService {
    ...
    async setOpenStatus(id, open) {
        const entity = await this.repo.findOne({ where: { village_id: id } });
        if (!entity)
            throw new common_1.NotFoundException(`Village ${id} not found`);
        entity.is_open = open;
...
exports.VillagesService = VillagesService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(craft_village_entity_1.CraftVillage)),
