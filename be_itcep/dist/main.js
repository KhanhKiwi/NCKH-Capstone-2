...
async function bootstrap() {
    ...
    const document = swagger_1.SwaggerModule.createDocument(app, config, {
        include: [auth_module_1.AuthModule, users_module_1.UsersModule, villages_module_1.VillagesModule, crafts_module_1.CraftsModule, progress_module_1.ProgressModule, sessions_module_1.SessionsModule, media_module_1.MediaModule, levels_module_1.LevelsModule, user_challenges_module_1.UserChallengesModule],
    });
